...
Coverage: 23 replicas, 42 blocks, 2193 attempted / 2192 settled payments. Enhanced strict-schema blocks: 25; safety-eligible: 18.

| Comparable area | Revenue Ops | CLBOSS | Current leader |
|---|---:|---:|---|
| Routing volume (msat) | 10222721354 | 30840803657 | clboss |
| Forward count | 536 | 1511 | clboss |
| Gross routing fees (msat) | 1234677 | 189646 | revenue_ops |
| Rebalance cost (msat) | 0 | 0 | tie |
| Net routing profit (msat) | 1234677 | 189646 | revenue_ops |
| Gross yield (ppm) | 120.778 | 6.149 | revenue_ops |
| Volume share (%) | 24.895 | 75.105 | clboss |
| Mean worst imbalance (ppm; lower is better) | 668974.7 | 702046.2 | revenue_ops |
...
Across the two controlled rounds Revenue delivered 100,000 sats for 2.104 sats
while uncapped CLBOSS delivered zero. Revenue's fixture routing income was
222.746 sats before rebalance cost, versus 1.500 sats for CLBOSS. The refill
moved each Revenue destination from below the 30% threshold into the operating
band; untouched empty/full LND lanes mean the contender-wide worst-imbalance
metric remains unsuitable for this fixture.
...
| Controlled depletion | Whether each native controller repairs the same exact 75/25 liquidity state | Implemented and crossed in replicas 52-53; Revenue leads 2-0 while CLBOSS remains uncapped. Extend to sustained post-refill demand. |
| Reserved return lane | Whether a controller can complete a profitable circular refill after pressure | Implemented with equal post-pressure 2M-sat CLN/LND paths; Revenue completed two safety-clean refills. |
