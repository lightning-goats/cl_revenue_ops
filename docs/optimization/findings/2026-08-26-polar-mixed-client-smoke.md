...
| Regression suite | Focused rebalance suites: 519 passed. Planner plus operator/reporting regressions: 94 passed. Pending/atomic/engine suites after the late-success cooldown fix: 128 passed. Fee-controller family after the dry-run fix: 652 passed. Final exact-pinned Python 3.11 full suite: 3,726 passed, 5 environment-dependent skips, and 2 intentional expected failures. |
