...
Current contract: plugin version 3.0.0, 2026-08-13.
...
and LN+. The plugin registers 37 methods. Removed method families are not
...
- `revenue-history`
- `revenue-forward-history` with explicit UTC-midnight bounds
